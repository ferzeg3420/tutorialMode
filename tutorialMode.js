...
(function () {
    ...
    function showCurrentTooltip(currentTooltip, currentTutorialElement) {
        return new Promise( resolve => {
            ...
            let focusedElementRect = currentTutorialElement.getBoundingClientRect();
            ...
            if( currentTooltip.classList.contains("tutorial-text-above") ) {
                ...
                currentTooltip.style.top = 
                    String(focusedElementRect.top - 20 - (tooltipRect.bottom - tooltipRect.top))
                    + "px";
                currentTooltip.style.left = String(focusedElementRect.left + 10) + "px";
                resolve('resolved');
                return;
            }
            triangle.style.top = String(focusedElementRect.bottom + 5.5) + "px";
            triangle.style.left = String(focusedElementRect.left + 14) + "px";
            currentTooltip.style.top = String(focusedElementRect.bottom + 20) + "px";
            currentTooltip.style.left = String(focusedElementRect.left + 10) + "px";
            resolve('resolved');
        });
    }
    ...
    function startTutorial(e, startTutorialBox, invisibleCover, clickMessage) {
    ...
    const tutorialControls = insertTutorialAndGetTutorialControls();
